    ...
    <section className="section-shell bg-gradient-to-b from-brand-navy via-[#081430] to-[#061229] text-white" id="why-us">
      <div className="page-container">
        <div className="section-title">
          ...
          <h2 className="text-white">Built for Engineering Projects, Not Template Sales Pages</h2>
          <p className="text-white/70">
            A premium outdoor lighting partner with stable manufacturing, professional support, and global project
            experience.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {whyChooseUs.map((item) => (
            ...
            >
              ...
              <h3 className="text-[20px] leading-[1.2] tracking-tighter3 font-semibold text-white">{item.title}</h3>
